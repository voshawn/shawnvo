...
### What is this?
Hi, I'm so glad we are working together. To make this an awesome relationship, there are some things you should know about me.
Remember that this document, like myself, is a work in progress. Issues and pull requests are welcome! I will keep you updated as I make changes. 

### About My Job 
Here are my primary responsibilities at the moment as CTO/COO:
...
2. Create an environment for all employees to do their most impactful work and lead their most fulfilling lives. I aim to build a system that aligns individual aspirations with our company's needs and objectives.  I want to ensure you're where you want to be and growing at your desired rate. If I do this well, I hope we can work together for a long time. And if the day comes when that alignment is no longer possible, I want you to look back on Denim as one of the best places you have ever worked. 
3. Provide context on priorities, why things are a certain way, why we do certain things, and where we want to go. I have a lot of knowledge about our company's historical and "global" context, so by sharing it with you, you can make the best decisions for the company. 
...
Sometimes, I will dump information to you on Slack because I'm thinking about it right now, but I don't expect you to respond right away.
If it is unrelated to something we recently talked about or if it's really early, really late, or on weekends, please respond when it's most convenient.

I expect you to set your Slack "notifications preferences" based on your working hours. If it is truly an emergency, I will "notify you anyway." I have done this two times in the last year.  This is the best way for us to feel comfortable detaching. 
...
#### Flash Tags
In a fully remote setting, it is often hard to tell how strongly a person feels about a particular idea. We want to encourage people to share their thoughts freely. However, when the CTO makes a statement, it might be perceived as a strong directive when it is just a mere suggestion. 
Below is how I try to use "flashtags" in my statements. 

- **#fyi or #idea:** I haven't spent much time thinking about it. You can read it or not. Act on it or not. No response is needed or expected.
...
- **#recommndation:** I've thought about this a lot. It's kept me up at night. I dug in. I understand the tradeoffs. You can choose not to take the recommendation and go your own way, but please do it for good reasons.  Please dig in a bit yourself and have a well-reasoned rationale for why you don’t want to take the recommendation. Please don’t ignore or dismiss it out of hand. A response (either way) is politely requested.
...
1. **Strategy Monday:** This is where I have my "Strategy" meetings to set the pace for the week. This usually includes Exec Session or other planning meetings. 
2. **Deep Work Tuesday:** This is for me to work on my big "rocks" for the week. This is when I would be deep in coding, designing, or working through a hard problem that requires focus.  
3. **1:1 Wednesday:** This day is for our personal growth. This is where we will have most of our 1:1s (see below). We can also schedule working sessions on these days. 
...
5. **Staff Friday:** My ideal Friday will be to lead productive staff meetings and get some deep work in before the weekend. 
...
7. **Team Standups / Planning / etc:** All teams reporting to me will likely have recurring standups or planning meetings. I will occasionally drop into these meetings if there is a project I am actively involved in.

For us to sync up our calendars, I encourage people who report to me to have a calendar schedule that allows us to keep Wednesdays and Thursdays open for collaboration.  
...
### Feedback
We should feel safe delivering feedback to each other. There will never be any punishment associated with delivering or receiving feedback. If anything, we reward that.
...
### How I Delegate
In order for me to delegate effectively, there are three things we need to be aligned on. I will articulate these three things, but if you feel like they aren't there, please help us get there. 

1. I need to trust that you deeply understand the problem we are trying to solve. The "success criteria" should be clear. This is not "what needs to be done" but "what is the outcome or result if we do it well?". 
...
3. I need to trust that you have the proper priority and urgency levels for the work that needs to be done. We need to align on what is most important at the time. This is especially important since we often have more work than time, so we need to prioritize effectively. 
